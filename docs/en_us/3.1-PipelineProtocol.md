...
- `action`: *string*  
    Action to execute. Optional, default is [`DoNothing`](#donothing) | [`Click`](#click) | [`LongPress`](#longpress) | [`Swipe`](#swipe) | [`MultiSwipe`](#multiswipe)| [`TouchDown`](#touchdown)| [`TouchMove`](#touchmove)| [`TouchUp`](#touchup) | [`Scroll`](#scroll) | [`ClickKey`](#clickkey) | [`LongPressKey`](#longpresskey)| [`KeyDown`](#keydown)| [`KeyUp`](#keyup) | [`InputText`](#inputtext) | [`StartApp`](#startapp) | [`StopApp`](#stopapp) | [`StopTask`](#stoptask) | [`Command`](#command) | [`Shell`](#shell) | [`Custom`](#custom-1)
